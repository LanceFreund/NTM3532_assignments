...
$faces = array("Cherry", "Bar", "Double Bar", "Triple Bar", "Diamond", "Seven");
        ...
        /* TODO New Lines: Setup an associative array named payouts. An associative array requires that you have a key and a value. The key in our case is the winning slot machine spins. In the form of 'Bar|Bar|Bar'. The '|' represents the separation of the wheels. The value is how much money they win it they spin any of the keys i.e 'Bar|Bar|Bar'. The key always points at the value like so: 'Bar|Bar|Bar' => '10'. So the possible combinations are: 'Bar|Bar|Bar' pays '10', 'Double Bar|Double Bar|Double Bar' pays '20', 'Triple Bar|Triple Bar|Triple Bar' pays '30', 'Cherry|Cherry|Cherry' pays '50', 'Seven|Seven|Seven' pays '70', 'Diamond|Diamond|Diamond' pays '100' (DONE)*/
...
$bust = "true";
    ...
    This tests to see if the randomly generated results of each wheel match up with a winning key: 'Bar|Bar|Bar'. Add these two lines to the if: $total = $total + $payouts[$slot_result]; echo "You won: $" . $payouts[$slot_result]; Add these two lines to the else: $total = $total - 10; echo "You lost: $10";
         */
